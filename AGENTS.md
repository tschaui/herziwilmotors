...
- Real visitor stats (no raw IPs, GDPR-friendly, cookie-free) are served by GoatCounter: tracking tag in `index.html` (`data-goatcounter="https://tschaui.goatcounter.com/count"`, script `//gc.zgo.at/count.js`). Dashboard at https://tschaui.goatcounter.com/.
